...
class TaskRunnerWindows : public TaskRunner {
 public:
  ...
  // Stops accepting callbacks and detaches the HWND before the Flutter
  // messenger and engine are destroyed. Safe to call more than once.
  void Shutdown();

  TaskRunnerWindows();
  ~TaskRunnerWindows() override;
